...

{
    ...
    empPayroll.name = "Akshay";
    console.log(empPayroll.toString());
    let newEmployeePayroll = new EmployeePayroll(1, "Ajay", 40000, "M", new Date());
...
*/
{
    ...
    try {
        ...
        empPayroll.salary = 40000;
        empPayroll.gender = 'M';
        empPayroll.startDate = '10-12-2021';//MM-DD-YYYY
        console.log(empPayroll.toString());
    }
    catch (e) {
        console.error(e);
    ...
    let newEmployeePayroll = new EmployeePayroll(1, "Ajay", 50000, "M", new Date());
    console.log(newEmployeePayroll.toString());        
}